...
[x] Scoop litter. There is an actual interaction for clearing out poop in litter. Remember, poop becomes more and more visible in the poop box as it accumulates.
[x] Cat gets in trouble, it goes in punishment box. We'll have a separate area with food, potty, water, but its clearly a separte place and its a little clear that its not for fun
[x] Backyard. The backyard doesn't have dogs, it doesn't have gathering things. It's where your cat is in freedom, it has trees. if it's a special occasion (easter is coming up) you can do an egg hunt.
[x] Special people get a special mod pack. Access to more stuff in the store. If you have one of them, they have less price. Some of the items have special visual effects and stuff. One of the items is a special grow boost but you can only buy it once. To get the special mod pack you need a special password (CORAROCKS)

[x] We want a dressing room where you can choose all the things you bought to try it on. So in the store, you just buy stuff, but in the dressing room you get to equip it. The dressing room gets accessed by a door.
[x] Add color to the eggs and have there be something in there
[x] There are birds and little critters to chase. Catching them gives you a food bonus
[x] Pet your cat
[x] Different music options. General improvements to music. Can we do a rich midi type soundtrack? Something higher quality but still free — added a second calmer procedural care theme + Calm toggle (still no bundled audio files).
[x] If you get all the cats, you get a magical or circus cat, ones that look super special and maybe have special visual effects. These special cats are not visible from the choose a cat screen unless you have all the cats
[x] Cat tunnels. Cat can travel inside it and peek out if they're using it
